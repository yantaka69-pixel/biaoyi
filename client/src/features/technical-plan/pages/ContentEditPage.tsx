...
function ContentEditPage({
  ...
  const pauseGeneration = async () => {
    ...
    try {
      await window.biaoyi?.tasks.pauseContentGeneration();
  ...
  const resumeGeneration = async () => {
    ...
    try {
      await window.biaoyi?.tasks.startContentGeneration({ resume: true });
  ...
  const retryContentCorrection = async () => {
    ...
    try {
      await window.biaoyi?.tasks.startContentGeneration({ retryContentCorrection: true });
  ...
  const retryFailedSections = async () => {
    ...
    try {
      await window.biaoyi?.tasks.startContentGeneration({ retryFailedSections: true });
  ...
  const continuePostProcessing = async () => {
    ...
    try {
      await window.biaoyi?.tasks.startContentGeneration({ continuePostProcessing: true });
  ...
  const rerunIllustrations = async () => {
    ...
    try {
      await window.biaoyi?.tasks.startContentGeneration({ rerunIllustrations: true });
  ...
  const launchContentGeneration = async ({
    ...
    await window.biaoyi?.tasks.startContentGeneration({
      regenerate,
